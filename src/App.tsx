      ...
      <div className="flex-1">
        ...
        <header className="bg-white/70 backdrop-blur-xl border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <button
              onClick={toggleTransactionModal}
              className="flex items-center gap-2 bg-gray-900 hover:bg-gray-800 px-4 py-2 rounded-lg transition-colors text-white ml-auto"
            >
        ...
        <main className="p-6">
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Balance Card */}
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl p-6 hover:bg-white/80 transition-colors">
